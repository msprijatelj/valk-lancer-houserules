...
* **Everest Frame** (Replacement, Removal): This came from a suggestion from Perijove on the PilotNET Discord server: 
...
* **Death’s Head Frame** (Replacement):
...
* **Mourning Cloak Frame** (Replacement):
...
* **Minotaur Frame** (Addition, Replacement): Most of these changes were cribbed from [Kai Tave](https://kaitave.itch.io/), a Lancer content creator.
